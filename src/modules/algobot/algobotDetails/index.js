                    ...
                    <div>
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html: strategy?.shortDescription,
                        }}
                      />
                    </div>
                  </div>
                      ...
                      {strategy.strategyPlan?.some(
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const categoryParam = searchParams.get("category");
                            router.push(
                              `/my-algobot-details?algobotId=${strategy?._id}${
                                categoryParam
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const categoryParam = searchParams.get("category");
                            router.push(
                              `/algobot-details?algobotId=${strategy?._id}${
                                categoryParam
                                  ? `&category=${categoryParam}`
                                  : ""
                              }`
